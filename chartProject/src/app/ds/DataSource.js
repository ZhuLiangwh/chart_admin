define(['common/utils/klass', 'common/utils/url'], function(klass, UrlUtil) {
    ...
    proto._load = function(url, httpConfig, isAbs) {
        return this._makeHttpRequestPromise(this, 'GET', (isAbs ? url : this._getApiUrl(url)), httpConfig);
    };
    proto._update = function(url, httpConfig, isAbs) {
        return this._makeHttpRequestPromise(this, 'POST', (isAbs ? url : this._getApiUrl(url)), httpConfig);
    };
